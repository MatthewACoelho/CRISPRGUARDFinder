...
geom_boxplot() + labs(title= "Cas9: GUARD Position", x=NULL, y="Overlap with gRNA (bp)") +
...
```{r OffGuideOverlap functioal vs non-functional HiFiCas9 stats}
# OffGuideOverlap functioal vs non-functional HiFiCas9 stats

mean_notperfect <- data_clean_HiFiCas9_split %>% group_by(Perfect) %>% filter(Perfect == "FALSE")
mean_perfect <- data_clean_HiFiCas9_split %>% group_by(Perfect) %>% filter(Perfect == "TRUE")

t.test(mean_notperfect$OffGuideOverlap, mean_perfect$OffGuideOverlap, var.equal = TRUE)

```

```{r plot HiFiCas9 OffGuideOverlap}
...
geom_boxplot() + labs(title= "HiFi-Cas9: GUARD Position", x=NULL, y="Overlap with gRNA (bp)") +
