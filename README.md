...
The Shiny app requires insatllation of further R packages "shiny" (version 1.4.0.2), "tidyverse" (version 1.3.0) and "DT" (version. 0.13), which can be installed in R with 'install.packages("package_name")'.
